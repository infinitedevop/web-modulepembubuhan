      ...
      <span className='flex' style={{background: '#D9D9D9'}}>
        ...
        >
          ...
          <p className='font-semibold'>
            <input type='text' value={pageNumber} style={{width: '30px'}} onChange={handleChange} />{' '}
            of {numPages || '--'}
          </p>
          <button
            type='button'
        ...
        <div
          id='pdf-wrapper mx-auto'
          style={{width: 'fit-content', margin: '0 auto', marginTop: '3rem'}}
        >
        ...
        <div className='mt-5' style={{padding: '0 5rem '}}>
          <label className='text-center mt-6'>
            ...
            menerima email Anda bisa klik tombol <b>kirim ulang email</b>, atau Anda bisa langsung{' '}
          ...
          <div className='preview-btn mt-7 mb-5'>
            ...
            <button
              className={`${disableBtn ? 'disabledbtn' : 'btn-download'}`}
              onClick={downloadPdf}
            >
              Download
            </button>
          ...
          <span className='pembubuhan-warning'>
            ...
            Dokumen hanya bisa dikirim ulang email atau didownload selama satu hari setelah
            pembubuhan
          </span>
        </div>
      </span>
